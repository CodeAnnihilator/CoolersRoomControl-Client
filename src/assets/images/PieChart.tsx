...
const PieChart: React.FC<any> = ({fill}) => (
	<Svg width={24} height={24} viewBox='0 0 476.3 476.3'>
		<Path fill={fill} d='M411.75,250.2h-185.6V64.6c0-7.5-6-13.5-13.5-13.5c-117.2,0-212.6,95.4-212.6,212.6s95.4,212.6,212.6,212.6
		...
		<Path fill={fill} d='M476.25,211.9c-0.2-51.6-19.1-101.3-53.2-140C382.65,26.2,324.65,0,263.65,0c-7.5,0-13.5,6-13.5,13.5v199.1
